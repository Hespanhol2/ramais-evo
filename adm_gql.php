...
<html lang="pt-br">
  <head>
    ...
    <title>Ramais Gestão do Conhecimento</title>
...
?>
  <a href="adicionar.php"> &nbsp;<button type="button" class="btn btn-success">Adicionar Novo Usuário</button></a> 
  ...
  <div class=container3>
   ...
   <th>Ramal</th>
    ...
    <?php
    $sql = "SELECT * FROM usuarios  where setor like '%gc%'";
    $sql = $pdo->query($sql);
    if($sql->rowCount() > 0){
